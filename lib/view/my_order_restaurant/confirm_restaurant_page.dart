...
class ConfirmRestaurantPage extends StatefulWidget {
  const ConfirmRestaurantPage({super.key});

  @override
  State<ConfirmRestaurantPage> createState() => _ConfirmRestaurantPageState();
}

class _ConfirmRestaurantPageState extends State<ConfirmRestaurantPage> {
  @override
    ...
    return ChangeNotifierProvider<OrderViewModel>(
      create: (context) => OrderViewModel(orderRepository: getIt())
        ..fetchOrderRestaurantListByStatus(
            CustomerDB.getCustomer()!.customer_id!, 0),
      child: Scaffold(

...
class FinishedRestaurantPage extends StatefulWidget {
  const FinishedRestaurantPage({super.key});

  @override
  State<FinishedRestaurantPage> createState() => _FinishedRestaurantPageState();
}

class _FinishedRestaurantPageState extends State<FinishedRestaurantPage> {
  @override
